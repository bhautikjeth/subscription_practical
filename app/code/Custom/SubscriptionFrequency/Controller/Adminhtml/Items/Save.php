...
class Save extends \Custom\SubscriptionFrequency\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('custom/subscriptionfrequency');
                        ...
                        $imagePath = 'custom/subscriptionfrequency'.$result['file'];
